<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="exporter2.aspx.vb" Inherits="aprequest.exporter2" %>
...
<uc1:Toplinks ID="Toplinks1" runat="server" />
        ...
        <div style="width: 60%; float: left;">
            ...
            <br />
            <asp:LinkButton ID="lnkBack" runat="server" CssClass="smalltext">&lt;&lt;&nbsp;back</asp:LinkButton>
        </div>
        <div style="width: 100%; clear: both; margin: 0px auto; text-align: center">
            <h1>Export Page</h1>
        ...
        <div id="filterdiv" style="width: 100%; padding: 3px 0px 5px 4px; clear: both; float: none;">
            ...
            Show only:
                    <asp:DropDownList ID="ddlFilter" runat="server" Width="70%"/>
            </div>
            <div style="float: left; width: 38%;">
                Sort by:
                    <asp:DropDownList ID="ddlSort" runat="server">
                        <asp:ListItem Value="create_at" Text="Date" />
                        <asp:ListItem Value="entity_id" Text="Entity" />
                    </asp:DropDownList>
            ...
            <div style="text-align: center;">
                ...
                <div style="width: 600px; height: 100px; clear: both; margin: 5px auto 50px;">
                    <div style="float: left; width: 150px; margin: 20px 5px 0px;">
                        <asp:Button ID="btnApprove" runat="server" Text="Approve Checked Items" CssClass="button-primary" />
                    </div>
                    <div style="float: left; border: 1px dotted #eac; padding: 5px; width: 350px; margin: 2px 20px 10px;">
                        Effective Date: <asp:TextBox ID="txtEffDate" MaxLength="10" Width="100px" CssClass="align-center" runat="server"></asp:TextBox><br />
        ...
        <asp:Button visible="false" ID="btnTest" runat="server" Text="test!" />
        <asp:Literal ID="litDbg" runat="server"></asp:Literal>
    </form>
    ...
    <textarea id="txtHoldReason" name="txtHoldReason" style="font: normal 7pt sans-serif; width: 95%; height: 100px;"></textarea>
